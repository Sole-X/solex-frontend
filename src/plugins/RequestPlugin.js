...
export default class RequestPlugin {
  ...
  async get(action, params) {
    return await this.executeRequest('GET', this.getRequestUrl(action), params, action);
  }

  async post(action, params) {
    return await this.executeRequest('POST', this.getRequestUrl(action), params, action);
  }

  async put(action, params) {
    return await this.executeRequest('PUT', this.getRequestUrl(action), params, action);
  }

  async delete(action, params) {
    return await this.executeRequest('DELETE', this.getRequestUrl(action), params, action);
  }
