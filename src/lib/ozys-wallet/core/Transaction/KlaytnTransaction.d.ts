...
export declare class KlaytnTransaction extends Transaction implements KlaytnTransaction.Data {
    ...
    constructor(type: KlaytnTransaction.TxType, method: string, params: [string | number | [string] | [number]], value: string, from: string, to: string, data?: string | undefined, abi?: object | undefined);
