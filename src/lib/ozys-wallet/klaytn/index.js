...
var KlaytnWallet = /** @class */ (function (_super) {
    ...
    KlaytnWallet.prototype.select = function (newProps) {
        var service = newProps.service, otherOptions = newProps.otherOptions;
    ...
    KlaytnWallet.prototype.getBalance = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._caver.rpc.klay.getBalance(address).then(function (res) {
    ...
    KlaytnWallet.prototype.getBlockNumber = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._caver.rpc.klay.getBlockNumber().then(function (res) {
                            return Number(res);
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
