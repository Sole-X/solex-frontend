...
var KlaytnKaikasWallet = /** @class */ (function (_super) {
    ...
    KlaytnKaikasWallet.prototype.broadcastTx = function (txParams) {
        ...
        var _sendTx = function () {
            window.caver.klay.sendTransaction(_tx)
        ...
        if (!_tx.gas) {
            window.caver.klay.estimateGas(txParams).then(function (res) {
                _tx.gas = res;
                _sendTx();
            }).catch(function (error) {
                eventBus.error(error);
    ...
    KlaytnKaikasWallet.prototype.broadcastFeeDelegateTx = function (txParams, eventBus) {
        ...
        var _sendTx = function () {
            window.caver.klay.signTransaction(_tx).then(function (tx) {
                if (!tx || !tx.rawTransaction) {
                    eventBus.error(new Error('sign_failed'));
                    return;
                }
                axios_1.default.post(_this.requestUrl[networkId], {
                    jsonrpc: '2.0',
                    id: 1,
                    ...
                    _this.watchTxReceipt(res.data.result).then(function (receipt) {
                        eventBus.receipt(receipt);
                    }).catch(function (error) {
                        eventBus.error(error);
                    });
    ...
    KlaytnKaikasWallet.prototype.signMessage = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, window.caver.klay.sign(msg, window.klaytn.selectedAddress)
    ...
    KlaytnKaikasWallet.prototype.watchTxReceipt = function (txHash, pollingCount) {
        if (pollingCount === void 0) { pollingCount = 15; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        var timer = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, window.caver.klay.getTransactionReceipt(txHash).catch(function () {
                                            return '';
                                        }).finally(function () {
                                            i += 1;
                                        })];
