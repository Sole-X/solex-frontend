...
var IconIconexWallet = /** @class */ (function (_super) {
  ...
  IconIconexWallet.prototype.serializeTx = function (params, type) {
    var serializedMessage =
      type === IconTransaction_1.IconTransaction.TxType.CALL ? 'icx_call.' : 'icx_sendTransaction.';
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.estimateStep(account, _tx.to, method, value, params)
                .then(function (res) {
                  return String(res);
                })
                .catch(function () {
          ...
          case 1:
            ...
            _c.label = 2;
          case 2:
            result = new IconTransaction_1.IconTransaction(
              type,
              account,
              _tx.to || '',
              value,
              _tx.data || '',
              icon_sdk_js_1.IconConverter.toHex(network.id),
              stepLimit,
              method,
              params,
            ).build();
