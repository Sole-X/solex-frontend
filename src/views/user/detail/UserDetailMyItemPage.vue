    ...
    <article class="user-collapsible user-item__in-wallet">
      <ui-collapsible ref="inWallet">
        <user-collapsible-header
          ...
          :total="getSearchedItems.wallet.length"
        />
        ...
        <section v-else class="user-collapsible__content">
          <div class="user-item__list">
            <div
              :class="$bem('asset-item-card', '', item.status === 'depositProgress' ? ['processing'] : '')"
              v-for="item in getSearchedItems.wallet"
              :key="item.id"
            >
              <section
                class="asset-item-card__thumbnail"
                @click="handleClickItem(item)"
                :style="inwalletImages[item.tokenAddress + '_' + item.tokenId]"
              >
              ...
              <section class="asset-item-card__modal">
                <div
                  v-if="item.status === 'depositProgress'"
                  :class="$bem('asset-item-card__modal__body', '', ['progress'])"
                >
                  <div class="asset-item-card__modal__anim"></div>
    ...
    <article class="user-collapsible user-item__in-wallet">
      <ui-collapsible ref="inSolex">
        <user-collapsible-header
          ...
          :total="getSearchedItems.deposited.length"
        />
        ...
        <section v-else class="user-collapsible__content">
          <div class="user-item__list">
            <div
              :class="$bem('asset-item-card', '', item.status === 7 ? ['processing'] : '')"
              v-for="item in getSearchedItems.deposited"
              :key="item.id"
            >
              <section
                class="asset-item-card__thumbnail"
                  ...
                  <div class="asset-item-card__modal__action">
                    <div>
                      ...
                      <template v-if="isAvailWithdraw(item)">
                        <button
                          :class="$bem('common-submit-button', '', ['no-line'])"
                          @click="handleWithdrawItem(item)"
                        >
                      ...
                      <template v-else>
                        <button
                          :class="$bem('common-submit-button', '', ['no-line'])"
                          @click="handleWithdrawItemToOther(item)"
                        >
    ...
    <article class="user-collapsible user-item__in-order">
      <ui-collapsible ref="onSale">
        <user-collapsible-header
          ...
          :total="getSearchedItems.onTrade.length"
        />
        ...
        <section v-else class="user-collapsible__content">
          <div class="user-item__list">
            <div
              :class="$bem('asset-item-card', '', item.type === 1 ? ['processing'] : '')"
              v-for="item in getSearchedItems.onTrade"
              :key="item.id"
            >
              <section
                class="asset-item-card__thumbnail"
                ...
                <div :class="$bem('asset-item-card__modal__body', '', '')">
                  <div class="asset-item-card__modal__action">
                    <div>
                      <button
                        :class="$bem('common-submit-button', '', ['no-line'])"
                        @click="goToItemDetailPage(item, true)"
                      >
                        {{ $t('UserPage.ShowItem') }}
                      </button>
                    </div>
...
export default {
  ...
  methods: {
    ...mapActions(['setUserItems', 'clearUserItems', 'setUserItemFilters', 'depositNft', 'withdrawNft', 'showModal']),
    ...
    initCollapsibleStatus() {
      ...
      this.$_UserCollapsibleMixin_initCollapsible([$refs.inWallet, $refs.inSolex, $refs.onSale]);
    },
