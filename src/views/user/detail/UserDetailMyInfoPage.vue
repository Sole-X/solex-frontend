    ...
    <section v-else class="user-info-page">
      <article class="user-info__summary">
        <div class="user-info__summary__title">
          <h1><strong>{{$t('UserPage.TotalBalance')}}</strong></h1>
        ...
        <div class="user-info__summary__user">
          <div class="user-info__summary__user__name">
            ...
            <div class="user-info__summary__user__name-welcome">{{$t('UserPage.WelcomeMessage')}}</div>
            <div class="user-info__summary__user__name-user">{{getUserInfo.username || getMaskedAddress(getUserInfo.address) || 'No activity'}}</div>
      ...
      <article class="user-info__banner">
