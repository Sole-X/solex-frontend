...
export default {
  ...
  computed: {
    ...mapGetters(['getSupportNft', 'getUserActivities', 'getUserActivityFilters']),
  ...
  methods: {
    ...
    initCollapsibleStatus() {
      ...
      this.$_UserCollapsibleMixin_initCollapsible([$refs.items, $refs.assets]);
    },
