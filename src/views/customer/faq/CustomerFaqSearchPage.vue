  ...
  <section class="customer-faq-tab">
    ...
    <div v-if="isData" class="customer-faq-tab__items">
      <div class="customer-faq-tab__item" v-for="(row, i) in items[$t('Customer.Language').toLowerCase()]">
        ...
        <div class="customer-faq-tab__item-description" v-show="itemShows[i]">
          <hr />
  ...
  methods: {
    ...
    setDatas() {
      ...
      for (let i = 0; i < this.itemCount; i++) {
        ...
        const offsetHeight = this.$refs[`item-description-${i}`]
          ? this.$refs[`item-description-${i}`][0].offsetHeight
          : 0;
