    ...
    <section class="staking-trix-amount">
      <div class="staking-trix-amount-container">
        <div class="staking-trix-amount-item">
          <div class="staking-trix-amount-item__title">
            <div v-if="$t('General.Language') === 'KOR'">
              <span class="staking-account" @click="()=>{this.$router.push('/user/asset?tab=2')}">Sole-X 계정</span> 내 TRIX 수량
            </div>
            <div v-else>
              Available TRIX in your <span class="staking-account" @click="()=>{this.$router.push('/user/asset?tab=2')}">Sole-X Account</span>
            </div>
            <div
          ...
          <div class="staking-trix-amount-item__balance-container">
            ...
            <div class="staking-trix-amount-item__balance-image">
              ...
              <img class="staking-trix-amount-item__balance-image-sub" :src="$static.getFileURL('img/icon/ic-staking-account.svg')" />
            </div>
          </div>
          <div>
            <button
            ...
            <button
              v-else
              :class="$bem('common-submit-button', '', ['disabled'])"
              disabled
            >
              {{ translated("StakeTrix") }}
            </button>
        ...
        <div class="staking-trix-amount-item">
          <div class="staking-trix-amount-item__title">
            <div v-if="$t('General.Language') === 'KOR'">
              Sole-X에 스테이킹한 TRIX 수량
            </div>
            <div v-else>
              Staked TRIX in Sole-X
            </div>
            <div
              v-if="$t('General.Language') === 'KOR'"
              class="staking-trix-amount-item__title-tooltip"
          ...
          <div class="staking-trix-amount-item__balance-container">
            ...
            <div class="staking-trix-amount-item__balance-image">
              <img :src="$static.getFileURL('img/icon/ic-token-trix.jpg')" alt='trix' />
              <img class="staking-trix-amount-item__balance-image-sub" :src="$static.getFileURL('img/icon/ic-staking-solex.svg')" />
            </div>
          </div>
          <div>
            <button
