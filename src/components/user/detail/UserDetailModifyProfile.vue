  ...
  <div class="user-modify-profile">
    ...
    <section class="user-modify-profile__form">
      ...
      <div class="user-modify-profile__form__input">
        <input type="text" :value="getUserInfo.address" disabled />
      </div>
    </section>
    ...
    <section class="user-modify-profile__form">
      ...
      <div class="user-modify-profile__form__input">
        <input type="text" v-model="username" :placeholder="$t('UserPage.UserNicknamePlaceholder')" />
...
export default {
  ...
  computed: {
    ...
    getWarningList() {
      return [$t('UserPage.MyProfileManageWarning1'), $t('UserPage.MyProfileManageWarning2')];
    },
  ...
  methods: {
    ...mapActions(['modifyUserInfo', 'checkUsernameRegex']),
