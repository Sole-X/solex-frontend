<template>
  <section class="gen-modal reserve-input-modal">
    ...
    <article class="gen-modal__content">
      ...
      <div v-if="data.action === 'transfer' || data.action === 'transferNft'" :class="$bem('reserve-input-modal__form', '', ['address'])">
          ...
          <div v-clipboard:copy="inputAddress" v-clipboard:success="inputAddressCopied">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 14 14">
              <g fill="none" fill-rule="evenodd">
                <g fill="#D8D8D8">
                  <path d="M9.1 0c1.16 0 2.1.94 2.1 2.1v.699l.7.001c1.16 0 2.1.94 2.1 2.1v7c0 1.16-.94 2.1-2.1 2.1h-7c-1.16 0-2.1-.94-2.1-2.1l-.001-.7H2.1C.94 11.2 0 10.26 0 9.1v-7C0 .94.94 0 2.1 0h7zm2.8 3.85h-7c-.58 0-1.05.47-1.05 1.05v7c0 .58.47 1.05 1.05 1.05h7c.58 0 1.05-.47 1.05-1.05v-7c0-.58-.47-1.05-1.05-1.05z" transform="translate(-1896 -53) translate(1690 30) translate(206 23)"/>
                </g>
              </g>
            </svg>
          </div>
      ...
      <div class="reserve-input-modal__agree-terms">
        <div v-if="data.action === 'transfer'" class="reserve-input-modal__agree-terms__text" v-html="$t('UserPage.ReserveInputTransferWarning')" />
    ...
    <article class="gen-modal__submit">
      <button :class="$bem('common-submit-button', '', (isAmountAvail && agreeTerms) ? ['primary'] : ['disabled'])" @click="handleSubmit()">
        {{$t('General.Confirm')}}
      </button>
    </article>
  </section>
